...
// Color definitions
static const Color RED    	= {.r = 255, .g = 0,   .b = 0};
static const Color GREEN  	= {.r = 0,   .g = 255, .b = 0};
static const Color BLUE 	= {.r = 0,   .g = 0,   .b = 255};
static const Color YELLOW 	= {.r = 255, .g = 255, .b = 0};
static const Color ORANGE 	= {.r = 255, .g = 120, .b = 0};
static const Color PURPLE 	= {.r = 255, .g = 0,   .b = 255};
static const Color WHITE  	= {.r = 255, .g = 255, .b = 255};
static const Color BLANK 	= {.r = 0,   .g = 0,   .b = 0};
