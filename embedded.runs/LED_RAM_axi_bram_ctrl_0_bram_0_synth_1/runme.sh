...
HD_PWD='/home/jacoboffersen/Repos/EmbeddedProject/embedded.runs/LED_RAM_axi_bram_ctrl_0_bram_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log LED_RAM_axi_bram_ctrl_0_bram_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source LED_RAM_axi_bram_ctrl_0_bram_0.tcl
